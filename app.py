...
# --- १. फीचर लोडर (यह बटन को प्रकट करता है) ---
...
# --- २. मुख्य यूआई (UI) ---
st.title("🔱 RAJARAM AI: GHOST EDITION")

# (यहाँ आपकी पुरानी चैट हिस्ट्री वाला कोड रहेगा)

# --- ३. जादुई चैटबॉक्स और बटन (The Layout) ---
st.write("---")
footer = st.container()
with footer:
    ...
    with col1:
        # आपका मुख्य टाइपिंग बॉक्स
        user_input = st.chat_input("🔱 अपना आदेश यहाँ लिखें...")
        
    with col2:
        # एआई द्वारा बनाई गई शक्तियाँ (जैसे माइक) यहाँ दिखेंगी
