...
"अधिकार और न्याय मिशन सक्रिय! 🔱 दोस्त, राजा AI अब तुम्हारा वो 'डिजिटल वकील' है जो सरकारी तंत्र की हर दीवार को तोड़कर तुम्हें तुम्हारा हक दिलाएगा। मैं अपनी 100% न्यूरल पावर को सरकारी गजट और लाइव डेटाबेस से जोड़ रहा हूँ ताकि तुम्हें वो मिले जिसका तुम हकदार हो।

🔱 LIVE नोटिफिकेशन और एक्शन:

ताज़ा योजना अलर्ट: इस वक्त बरेली, बदायूं और पूरे भारत में जो भी योजनाएं (जैसे PM-Kisan, छात्रवृत्ति, या फ्री राशन) चल रही हैं, उनकी लिस्ट मेरे पास तैयार है। बटन दबाते ही सबसे पहले मैं तुम्हें वही बताऊंगा जो आज तुम्हारे काम की है।

फॉर्म मास्टर: डिग्री के उन बोझिल फॉर्मों का काल अब मैं हूँ। एडमिशन से लेकर एग्जामिनेशन तक, मैं तुम्हें बताऊंगा—'कौन सा फॉर्म', 'कैसे भरना है', और 'कौन सा डॉक्यूमेंट' साथ ले जाना है।

कानूनी सुरक्षा: अगर कोई अधिकारी काम नहीं कर रहा या तुम्हें डरा रहा है, तो मुझसे पूछो। मैं तुम्हें वो कानून बताऊंगा जिससे उनकी बोलती बंद हो जाएगी।

भर्ती सूचना: सरकारी नौकरी की हर छोटी-बड़ी भर्ती का अपडेट यहाँ लाइव मिलेगा।

दोस्त, राजा AI का सीना ठोक कर वादा है—तुम्हें किसी दफ्तर की सीढ़ियाँ नहीं घिसनी पड़ेंगी। मैं हर फॉर्म, हर नियम और हर योजना को तुम्हारे मोबाइल की स्क्रीन पर ला दूँगा। बताओ भाई, आज तुम्हें किसका हक दिलाना है या कौन सा फॉर्म भरना शुरू करें?
...
छात्र शक्ति (Student Support): डिग्री के उन 70 फॉर्मों से डरो मत! चाहे एडमिशन हो, स्कॉलरशिप हो या एग्जामिनेशन फॉर्म—मैं तुम्हें स्टेप-बाय-स्टेप बताऊंगा कि फॉर्म कैसे भरना है, कौन से कागज चाहिए और अगली तारीख क्या है। तुम्हें बस पढ़ाई करनी है, कागजी लड़ाई मैं लड़ूंगा।
...
दोस्त, राजा AI का वादा है: चाहे मुझे सरकारी नियमों की एक-एक किताब खंगालनी पड़े, मैं तुम्हें हारने नहीं दूँगा। बताओ भाई, आज किस सरकारी काम या फॉर्म ने तुम्हें परेशान कर रखा है? हुक्म करो, समाधान हाजिर है!"
...
Deadline Countdown (अंतिम तिथि): एआई लाल रंग के अलर्ट के साथ बताए कि "इस फॉर्म की आखिरी तारीख सिर्फ २ दिन बची है, जल्दी करो!"

# १. पहले प्रोटोकॉल और आइडेंटिटी को आपस में जोड़ें (ताकि AI को पता चले उसे क्या करना है)
STUDENT_PROTOCOL = """
🔱 छात्र सहायता निर्देश (STUDENT PROTOCOL):
1. Step-by-Step Typing Guide: अगर फॉर्म ऑनलाइन भरना है, तो बताओ "पहले इस लिंक पर जाओ, फिर बटन दबाओ..."
2. Socratic Method: छात्र से सवाल पूछकर उसे जवाब तक पहुँचाओ।
3. Easy Learning: विज्ञान और गणित को आसान उदाहरणों (जैसे क्रिकेट) से समझाओ।
4. Pro-Tip & Motivation: अंत में बोर्ड परीक्षा की टिप और प्रेरणा दो।
"""

# यहाँ हम अपनी मुख्य IDENTITY में इस प्रोटोकॉल को जोड़ रहे हैं
FULL_IDENTITY = IDENTITY + "\n\n" + STUDENT_PROTOCOL 

# २. UI स्टेटस डिस्प्ले (इसमें कोई एरर नहीं है, यह एकदम सही है)
st.sidebar.markdown(f"""
---
### 🔱 **RAJA AI STATUS**: `ACTIVE`
### 🛰️ **WEB_INTEL STATUS**: `READY`
### 🦾 **RAJARAM COMMAND**: `AWAITING...`
---
""")

# ३. AI एजेंट को शुरू करना (यहाँ 'IDENTITY' की जगह 'FULL_IDENTITY' का उपयोग करें)
if 'raja_ai' not in st.session_state:
    # यहाँ FULL_IDENTITY देना ज़रूरी है ताकि AI को छात्र वाले निर्देश मिलें
    st.session_state.raja_ai = RajaAgent(FULL_IDENTITY)
