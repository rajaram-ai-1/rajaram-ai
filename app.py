...
# --- [STUDENT PROTOCOL SETTINGS] ---
# इसे आप अपने IDENTITY या SYSTEM_PROMPT वाले वेरिएबल में जोड़ें
STUDENT_PROTOCOL = """
...
# --- [UI STATUS DISPLAY] ---
# लाइन 353 के आसपास इस तरह लिखें ताकि एरर न आए
...
# अगर आप इसे मेन स्क्रीन पर दिखाना चाहते हैं तो 'st.sidebar' हटा दें।
