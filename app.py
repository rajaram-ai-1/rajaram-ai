...
# --- [नीचे का कोड Line 347 से पेस्ट करें] ---

# १. पहले प्रोटोकॉल और आइडेंटिटी को आपस में जोड़ें
STUDENT_PROTOCOL = """
...
# यहाँ FULL_IDENTITY बना रहे हैं (सुनिश्चित करें कि IDENTITY ऊपर कहीं डिफाइन है)
try:
    FULL_IDENTITY = IDENTITY + "\n\n" + STUDENT_PROTOCOL
except NameError:
    # अगर IDENTITY नहीं मिला तो सिर्फ प्रोटोकॉल इस्तेमाल करें
    FULL_IDENTITY = STUDENT_PROTOCOL

# २. UI स्टेटस डिस्प्ले
